...
- **Frontend**: `React 18`, `Vite`, `Tailwind CSS`, `Lucide Icons`, `Sonner Toasts`, `@vercel/analytics`.
- **Backend**: `Node.js`, `Express`, `Mongoose`, `JWT Authentication`.
- **Cloud/AI**: `Google Generative AI (Gemini 2.0 Flash Lite)`, `Inngest` (Event-driven background processes).
- **Database**: `MongoDB Atlas` (Optimized via indexing and lean queries).
- **Communication**: `Nodemailer`, `Mailtrap`.
